...
Se stai facendo il tutorial a casa e non durante una sessione di training con il tuo teacher, puoi saltare questo capitolo e andare direttamente a [Come funziona Internet](../how_the_internet_works/README.md).

Copriamo questi argomenti nel tutorial completo, e questa è una pagina aggiuntiva contenente tutte le istruzioni di installazione. Il teacher, comprende un training live dedicato all'installazione, in cui installiamo tutto, in modo da non preoccuparcene durante le sessioni di insegnamento
